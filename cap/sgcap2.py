    ...
    try:
        while True:
            try:
                ...
                # if bot == "lb(f5)":
                #     url = 'http://10.11.67.29:3000/d/sjElzXFVk/sg_f5_monitor?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/LB(F5)_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                # elif bot == "fw_1":
                #     url = 'http://10.11.67.29:3000/d/0kQdZuFVk/sg-fw-monitor?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/FW_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                # elif bot == "total_1":
                #     url = 'http://10.11.67.29:3000/d/qstVWXF4z/sg-prd-ccs-neteuweokeu-jonghab-moniteoring?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                # elif bot == "host_1":
                #     url = 'http://10.11.67.29:3000/d/dPViDjKVk/sg-bm-and-netapp-resource?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/HOST_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                # elif bot == "vm_1":        
                #     url = 'http://10.11.67.29:3000/d/5bY3CrK4z/sg-vm-resource?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/VM_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
 
                # elif bot == "database_1":
                #     url = "http://10.11.67.29:3000/d/RJrKguFVz/sg-prd-db-resource-usage-top-20?orgId=1&refresh=5m"
                #     filename = screenshots_path + '/DB_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                # elif bot == "mongo":
                #     url = 'http://10.11.67.29:3000/d/1Igbn754k/na_mongodb?orgId=1&refresh=5m'
                #     filename = screenshots_path + '/mongo_SG_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                # elif bot == "netapp_info":        
                #     url = 'http://10.11.67.29:3000/d/Bh1NWuF4k/sg-netapp-dash-board?orgId=1&refresh=5m'
