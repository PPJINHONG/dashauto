    ...
    try:
        while True:
            try:
                ...
                if bot == "lb(a10)":
                    url = 'http://10.11.67.29:3000/d/MYEQGw5Vk/rutms-a10-resource-monitor?orgId=1'
                    filename = screenshots_path + '/LB(A10)_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                elif bot == "fw_1":
                    url = 'http://10.11.67.29:3000/d/HK5wzuFVkasdf/rutms-fw_resource-monitor?orgId=1'
                    filename = screenshots_path + '/FW_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                elif bot == "total_1":
                    url = 'http://10.11.67.29:3000/d/-FwPmOcVz/ru-prd-ccs-neteuweokeu-jonghab-moniteoring?orgId=1'
                    filename = screenshots_path + '/RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
                elif bot == "host_1":
                    url = 'http://10.11.67.29:3000/d/rDJA39K4z/ru-bm-and-netapp-resource?orgId=1'
                    filename = screenshots_path + '/HOST_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                elif bot == "vm_1":        
                    url = 'http://10.11.67.29:3000/d/HEd3C9FVk/ru-vm-resource?orgId=1'
                    filename = screenshots_path + '/VM_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
    
                elif bot == "database_1":
                    url = "http://10.11.67.29:3000/d/3MMHzXKVz/ru-prd-db-resource-usage-top-20?orgId=1"
                    filename = screenshots_path + '/DB_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                elif bot == "netapp_info":        
                    url = 'http://10.11.67.29:3000/d/Rv-oDy54k/ru-netapp-dash-board?orgId=1'
                    filename = screenshots_path + '/NETAPP_INFO_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'

                elif bot == "storage_1":
                    url = "https://10.7.0.231/clusters/70559/explorer"
                    filename = screenshots_path + '/NPS1_RU_1center_PRD_' + datetime.now().strftime('%Y%m%d_%H%M') + '.png'
