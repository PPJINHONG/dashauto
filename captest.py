...
def take_screenshot(bot):
    ...
    try:
        ...
        urls = {
            "k8s_cluster_1center_ccskr-rancher-prd": 'https://hubble-apne2-prd.platform.hcloud.io/grafana/d/coBoVkG4z/kr-apne1-rancher-local?orgId=27',
            "k8s_cluster_1center_ccskr-devworks-prd": 'http://10.11.67.29:3000/d/1HihRd54k/coc-k8s-summary-dashboard-alert-system-kr1-kr_devworks_prd_cluster?orgId=1',
            "k8s_cluster_1center_ccskr-dkc2hpkr-prd": 'http://10.11.67.29:3000/d/oOYkgdc4z/coc-k8s-summary-dashboard-alert-system-kr1-dkc2-hpkr?orgId=1'
        }
